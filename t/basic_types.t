...
is_deeply(
  Mac::PropertyList::Foundation::parse_plist($array)->as_basic_data,
  [ qw(Green Yellow) ],
...
is_deeply(
  Mac::PropertyList::Foundation::parse_plist($dict)->as_basic_data,
...
is_deeply(
  Mac::PropertyList::Foundation::parse_plist($nested_array)->as_basic_data,
...
is_deeply(
  Mac::PropertyList::Foundation::parse_plist($nested_dict)->as_basic_data,
